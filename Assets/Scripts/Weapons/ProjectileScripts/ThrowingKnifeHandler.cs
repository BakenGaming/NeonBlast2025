...
public class ThrowingKnifeHandler : MonoBehaviour
{
    ...
    private void Update() 
    {
        if(target == null || target.gameObject.activeInHierarchy == false) { ObjectPooler.EnqueueObject(this, "Knife", PoolType.Projectiles); return;}
    ...
    private void OnTriggerEnter2D(Collider2D trigger) 
    {
        ...
        ObjectPooler.EnqueueObject(this, "Knife", PoolType.Projectiles);
    }
}
